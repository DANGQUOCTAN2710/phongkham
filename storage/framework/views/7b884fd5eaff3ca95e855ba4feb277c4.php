...
<main class="col-md-10 ms-sm-auto px-md-4">
    ...
    <div class="card p-3 mb-3">
        <form method="GET" action="<?php echo e(route('doctor.lab_waiting')); ?>">
            <div class="row">
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('lab.show', $key->id)); ?>" class="btn btn-success btn-sm d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; padding: 0;">
...
<?php echo $__env->make('doctor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\phongkham\resources\views/doctor/pages/lab_exam/list_lab.blade.php ENDPATH**/ ?>