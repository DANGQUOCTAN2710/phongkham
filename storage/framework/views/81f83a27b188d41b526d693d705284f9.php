...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div id="today-section" class="section">
        <h3 class="mb-3 text-center text-primary">Tất cả lịch hẹn tái khám</h3> 
        <form action="<?php echo e(route('doctor.all_schedule')); ?>" method="GET" class="row g-3 mb-4">
            <div class="col-md-4">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php $__currentLoopData = $allAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e(($allAppointments->currentPage() - 1) * $allAppointments->perPage() + $key + 1); ?></td>
...
<?php echo $__env->make('doctor.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\phongkham\resources\views/doctor/pages/schedule/all_list.blade.php ENDPATH**/ ?>